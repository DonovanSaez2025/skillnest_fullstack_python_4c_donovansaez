...
# 
# Salida: 7
# La función no tiene variables ni parámetros
...
#
# Salida:
# No hay variables ni parámetros ni tampoco una salida de datos.
...
# Variables | Valores
#
# Salida: Nos da un error porque cantidad_de_dias_en_el_anio() no existe.
...
#
# Salida: 2022
# No se ejecuta el segundo return porque ya hay uno antes, el return marca el final definitivo de la función.
...
#
# Salida: 12
# No se ejecuta el print(15) de la función porque hay un return antes que marca el final de la función.
...
# x         | None
# Salida: 24 - None
# Se imprime 24 por el print de la función, y None porque como no hay return en la función, la variable x se queda vacía
...
# b         | 5 - 3
# Salida: 15 - 7
# La función genera error ya que no hay un return.
...
# a         | 560000
# Salida: 560000 - 46
# No se ejecuta la última línea porque ya hay un return para cada lado del if, haciendo que el if sea el final de la función
...
# b         | 3 - 4 - 4 - 3
# Salida: 365 - 12 - 377
# No se ejecuta el return final porque ya hay return para cada lado del if.
...
# b         | 4
# Salida: 7
# No se ejecuta el segundo return porque ya hay otro encima.
...
# Variables      | Valores
# horas_de_juego | 150
# horas_de_juego (dentro de función) | 350
# Salida: 150 - 150 - 350 - 150
# hay dos variables con el mismo nombre, pero se tratan como diferente porque una está dentro de una función.
...
# horas_de_juego (dentro de función) | 350
# Salida: 150 - 150 - 350 - 150
# El return no hace nada porque no hay una variable ni algo parecido que esté guardando el valor al llamar la función
# y de nuevo, el segundo horas_de_juego se trata como una variable distinta al estar dentro de la función.
...
# a         | 1
# b         | 4
# Salida: Reproducciones: 5000 - Incremendo calculado: - 1 - 4